 ...
 */
class CourseServiceCommunicationTest {
    ...
    void success200Test() {
        ...
        assertEquals(Constants.RESPONSE_BODY, CourseServiceCommunication.serverRequest(request));
    }
    ...
    void noSuccessTest() {
        ...
        assertNull(CourseServiceCommunication.serverRequest(request));
    }
    ...
    void exceptionTest() {
        ...
        CourseServiceCommunication.serverRequest(request);
        assertNull(CourseServiceCommunication.serverRequest(request));
    }
    ...
    void getRequestSuccessTest() {
        ...
        assertEquals(Constants.RESPONSE_BODY, CourseServiceCommunication
    ...
    void getRequestNullTest() {
        ...
        assertNull(CourseServiceCommunication
