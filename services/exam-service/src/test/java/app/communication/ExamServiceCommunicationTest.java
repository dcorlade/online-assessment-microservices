 ...
 */
class ExamServiceCommunicationTest {
    ...
    void success200Test() {
        ...
        assertEquals(Constants.RESPONSE_BODY, ExamServiceCommunication.serverRequest(request));
    }
    ...
    void noSuccessTest() {
        ...
        assertNull(ExamServiceCommunication.serverRequest(request));
    }
    ...
    void exceptionTest() {
        ...
        ExamServiceCommunication.serverRequest(request);
        assertNull(ExamServiceCommunication.serverRequest(request));
    }
    ...
    void getRequestSuccessTest() {
        ...
        assertEquals(Constants.RESPONSE_BODY, ExamServiceCommunication
    ...
    void getRequestNullTest() {
        ...
        assertNull(ExamServiceCommunication
