 ...
 */
class StudentServiceCommunicationTest {
    ...
    void success200Test() {
        ...
        assertEquals(Constants.RESPONSE_BODY, StudentServiceCommunication.serverRequest(request));
    }
    ...
    void noSuccessTest() {
        ...
        assertNull(StudentServiceCommunication.serverRequest(request));
    }
    ...
    void exceptionTest() {
        ...
        StudentServiceCommunication.serverRequest(request);
        assertNull(StudentServiceCommunication.serverRequest(request));
    }
    ...
    void getRequestSuccessTest() {
        ...
        assertEquals(Constants.RESPONSE_BODY, StudentServiceCommunication
    ...
    void getRequestNullTest() {
        ...
        assertNull(StudentServiceCommunication
